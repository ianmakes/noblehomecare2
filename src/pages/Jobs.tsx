...
const Jobs = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="healthcare-gradient text-white min-h-[45vh] flex items-center pt-32 pb-12 md:pt-36 md:pb-16 overflow-hidden relative">
        ...
        <div className="container-custom relative z-10">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in">
              ...
              <Button className="btn-healthcare text-lg px-8 py-4 flex items-center gap-2" onClick={() => window.location.href = 'mailto:info@noblehomecarellc.com?subject=Job Application&body=Hello, I would like to apply for a position at Noble Homecare Agency. Please find my resume attached.'}>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
            {positions.map((position, index) => (
              <div key={index} className="bg-white p-4 md:p-8 rounded-2xl shadow-md hover:shadow-xl transition-all border-l-8 border-healthcare-gold">
                <div className="flex items-center mb-2 md:mb-4">
                  <Briefcase className="w-5 h-5 md:w-6 md:h-6 text-healthcare-green mr-2 md:mr-3" />
                  <h3 className="text-sm md:text-xl font-serif font-bold text-healthcare-green truncate">{position}</h3>
                </div>
                <div className="space-y-1 md:space-y-2 text-gray-600 mb-2 md:mb-4 text-[10px] md:text-sm">
                ...
                <p className="text-gray-600 text-[10px] md:text-sm line-clamp-2 md:line-clamp-none">
                  Join our compassionate care team and make a meaningful difference.
                </p>
              </div>
            ))}
          </div>
