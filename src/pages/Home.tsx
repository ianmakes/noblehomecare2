...
const Home = () => {
  ...
  return <div className="min-h-screen">
      ...
      <section className="relative healthcare-gradient text-white min-h-[40vh] md:min-h-[60vh] flex items-center pt-32 pb-6 md:pt-32 md:pb-10 lg:pt-36 lg:pb-14 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="animate-fade-in space-y-8">
              ...
              <div className="space-y-2 md:space-y-4">
                <h1 className="text-[1.75rem] xs:text-3xl sm:text-4xl md:text-6xl lg:text-8xl font-serif font-bold leading-tight text-white whitespace-nowrap md:whitespace-normal">
                  We <span className="text-healthcare-gold italic">Care</span> <br className="hidden md:block" /> For You!
                </h1>
