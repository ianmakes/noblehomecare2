    ...
    <div className="min-h-screen">
            ...
            <div className="animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button 
                  ...
                  className="btn-healthcare-outline bg-white/10 border-white text-white hover:bg-white hover:text-healthcare-primary text-lg px-8 py-4"
                >
                  Assess Care Needs
                </Button>
              </div>
      ...
      <section className="section-padding">
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-healthcare-secondary mb-6">
                We believe the heart of healthcare is service to others
              </h2>
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <CheckCircle className="w-6 h-6 text-healthcare-secondary mt-1 flex-shrink-0" />
                  <div>
      ...
      <section className="section-padding bg-healthcare-accent">
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-healthcare-secondary mb-6">Comprehensive Care Services</h2>
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <Heart className="w-6 h-6 text-healthcare-primary mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-lg mb-2">Medication Management</h4>
                    <p className="text-gray-600">Professional assistance with medication reminders and administration to ensure proper health management.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <Users className="w-6 h-6 text-healthcare-primary mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-lg mb-2">Mobility Assistance</h4>
                    <p className="text-gray-600">Safe support with walking, transfers, and daily mobility to maintain independence and prevent falls.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <Shield className="w-6 h-6 text-healthcare-primary mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-lg mb-2">Nutritional Support</h4>
                    <p className="text-gray-600">Meal planning, preparation, and dietary guidance to ensure proper nutrition and health.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {careProcess.map((process, index) => (
              <div key={index} className="text-center animate-fade-in" style={{animationDelay: `${index * 0.1}s`}}>
                <div className="w-16 h-16 bg-healthcare-secondary text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4">
                  {process.step}
                </div>
      ...
      <section className="section-padding relative overflow-hidden">
        ...
        >
          <div className="absolute inset-0 bg-healthcare-secondary/85"></div>
        </div>
