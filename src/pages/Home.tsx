  ...
  return <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button onClick={() => setIsConsultationModalOpen(true)} className="btn-healthcare-secondary text-lg px-8 py-4">
                  Get Free Consultation
                </Button>
                <Button onClick={() => setIsCareNeedsModalOpen(true)} className="btn-healthcare-outline border-white hover:text-healthcare-teal text-lg px-8 py-4 bg-slate-50 text-slate-900">
                  Assess Care Needs
                </Button>
              </div>
            </div>
      ...
      <section className="section-padding">
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <img src="/lovable-uploads/1e91caf8-562b-44e0-b88a-de8b391a9afe.png" alt="Healthcare professional providing personalized care to elderly patient" className="rounded-2xl shadow-xl w-full h-[400px] object-cover" />
            </div>
      ...
      <section className="section-padding bg-healthcare-gray-light">
        <div className="container-custom">
          ...
          <div className="text-center mt-12">
            <Button onClick={() => setIsCareNeedsModalOpen(true)} className="btn-healthcare text-lg px-8 py-4">
      ...
      <section className="section-padding relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
            {counties.map((county, index) => <div key={index} className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6 text-center animate-fade-in hover:bg-white/20 transition-all duration-300" style={{
      ...
      <section className="healthcare-gradient text-white section-padding">
        <div className="container-custom text-center">
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center">
            <Button onClick={() => window.open('tel:470-210-7666')} className="btn-healthcare-secondary text-lg px-8 py-4 flex items-center space-x-2">
              <Phone size={20} />
              <span>Call Now: 470-210-7666</span>
            </Button>
            <Button onClick={() => setIsConsultationModalOpen(true)} className="btn-healthcare-outline bg-white/10 border-white text-white hover:bg-white hover:text-healthcare-teal text-lg px-8 py-4">
