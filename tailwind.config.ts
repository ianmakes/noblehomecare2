	...
	theme: {
		...
		extend: {
			colors: {
				...
				'healthcare-green-dark': 'hsl(var(--healthcare-green-dark))',
				'healthcare-gold': 'hsl(var(--healthcare-gold))',
				'healthcare-gold-dark': 'hsl(var(--healthcare-gold-dark))',
				'healthcare-pink': 'hsl(var(--healthcare-gold))',
